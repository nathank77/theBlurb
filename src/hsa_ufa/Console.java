 ...
 *   - methods added to poll the keyboard state without pausing the program (good
 *     for live-action games) - ketKeyChar, getKeyCode, getLastKeyChar, etc.
...
public class Console extends JFrame {
  ...
  private static final String DEFAULT_NAME = "UFA Console";
  ...
  public void drawImage(Image img, int x, int y, ImageObserver i)
  {
    canvas.drawImage(img, x, y, i);
  }
  public void drawImage(Image img, int x, int y, int width, int height, ImageObserver i)
  {
    canvas.drawImage(img, x, y, width, height, i);
  }
  ...
  /**
   * Draws a star on the screen from (x, y) to (x + width, y + width). Adapted from hsa.
   *
   * @param x
